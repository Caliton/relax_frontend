      ...
      <q-card-section style="height: auto !important;">
        <div class="row justify-around">
          <div class="col-md-5 flex flex-center">
            <q-img
              src="~src/statics/departaments.png"
          ...
          <div class="col-md-5">
            <div class="column justify-center">
              <q-input
                ...
                :error="$v.departament.description.$error"
              >
...
export default {
  ...
  methods: {
    onShow (departament) {
      ...
      this.departament = { ...this.departament }
    ...
    validationsFields () {
      this.$v.departament.$touch()

      return this.$v.departament.$error
    },

    cleanFields () {
      this.departament = {}
      this.$v.departament.$reset()
    },
